    ...
    <div class="slider-area">
        <div class="swiper-container slider__active">
            <div class="slider-wrapper swiper-wrapper">
                <div class="single-slider swiper-slide slider-height d-flex align-items-center" data-background="{{asset('frontend')}}/assets/img/slider/01-slide-1.jpg">
                    <div class="container">
                        <div class="row">
                            {{--                            <div class="col-xl-5">--}}
                ...
                <div class="single-slider swiper-slide slider-height d-flex align-items-center" data-background="{{asset('frontend')}}/assets/img/slider/01-slide-2.jpg">
                    <div class="container">
                        <div class="row">
                            {{--                            <div class="col-xl-5">--}}
                            {{--                                <div class="slider-content">--}}
                ...
                <div class="single-slider swiper-slide slider-height d-flex align-items-center" data-background="{{asset('frontend')}}/assets/img/slider/01-slide-4.jpg">
                    <div class="container">
                        <div class="row">
                            {{--                            <div class="col-xl-5">--}}
                            {{--                                <div class="slider-content">--}}
