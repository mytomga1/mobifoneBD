        ...
        <div class="slider-wrapper swiper-wrapper">
            @foreach($banners as $key => $banner)
                <div class="single-slider swiper-slide slider-height d-flex align-items-center" data-background="@if($banner->image && file_exists(public_path($banner->image)))
                                                                                                                 ...
                                                                                                                 @endif
                                                                                                                " title="{{$banner->name}}" alt="{{$banner->title}}" href="{{ route('banner-detail', ['slug' =>$banner->slug]) }}">
                    <div class="container">
                        <div class="row">
{{--                                                        <div class="col-xl-5">--}}
...
{{--                                                                    <a data-animation="fadeInUp" data-delay="1.15s" href="{{ route('banner-detail', ['slug' =>$banner->slug]) }}" class="st-btn-b b-radius">Discover now</a>--}}
{{--                                                                </div>--}}
{{--                                                            </div>--}}
{{--                                                        </div>--}}
                        </div>
