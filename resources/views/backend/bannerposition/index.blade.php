...
{{--Date : 26/9/2023--}}
{{--Trang Danh Sách Vị Trí Banner--}}

@section('content')
    <!-- header content -->
    <section class="content-header">
        <h1>
            Danh Sách Vị Trí Banner
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Trang chủ</a></li>
            <li class="active">Danh Sách Vị Trí Banner</li>
        </ol>
    </section>
    <!-- end header content -->
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header with-border">
                        ...
                        {{--                        @endif--}}
                        <a href="{{ route('admin.bannerposition.create') }}" class="btn btn-primary pull-right"><i class="fa fa-plus" aria-hidden="true"></i></a>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            @foreach($data as $key => $item)
                                <tr class="item-{{ $item->id }}">
                                    ...
                                    <td class="action" >
                                        <a href="{{ route('admin.bannerposition.edit', ['bannerposition' => $item->id]) }}"><span title="Chỉnh sửa" type="button" class="btn btn-flat btn-primary"><i class="fa fa-edit"></i></span></a>
        ...
        $( document ).ready(function() {
                        ...
                        $.ajax({
                            ...
                            success: function (res) {
                                if(res.status) {
                                    ...
                                    window.location.href = "{{ route('admin.bannerposition.index') }}?filter_type="+filter_type;
                                } else {
                                    Swal.fire(
                                        'Thông báo !',
                                        res.msg,
            ...
            $('.restoreItem').click(function () {
                ...
                Swal.fire({
                    ...
                    text: "Dữ liệu sẽ được khôi phục lại Vị trí banner",
                    icon: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url : '/admin/bannerposition/restore/'+id,
                            type: 'POST',
                            data: {},
                            success: function (res) {
                                if(res.status) {
